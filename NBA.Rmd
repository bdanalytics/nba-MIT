...
title: "NBA: <Predict var> <regression/classification>"
author: "bdanalytics"
...
glb_is_classification <- FALSE; glb_is_regression <- !!glb_is_classification
...
# glb_entity_df$<col_name>.fctr.num <- sapply(1:nrow(glb_entity_df), 
#     function(row_ix) grep(glb_entity_df[row_ix, "<col_name>"],
#                           levels(glb_entity_df[row_ix, "<col_name>.fctr"])))

# glb_predct_df <- mutate(glb_predct_df, 
#                     )

# glb_predct_df$<col_name>.fctr.num <- sapply(1:nrow(glb_predct_df), 
#     function(row_ix) grep(glb_predct_df[row_ix, "<col_name>"],
#                           levels(glb_predct_df[row_ix, "<col_name>.fctr"])))
